        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://www.kinoplex.com.br/filmes/images/cartaz/262x388/john-wick-4-baba-yaga.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder"> John Wick 4 </h1>
                        Com o preço por sua cabeça cada vez maior, o lendário assassino de aluguel John Wick leva sua luta
                        contra o High Table global enquanto procura os jogadores mais poderosos do submundo, de Nova York 
                        a Paris, do Japão a Berlim.
                        <p class="lead"></p>
                        ...
                        <br>
                        <p> Gênero: Ação/Neo-noir <br> Classificação indicativa: 16 anos <br> Duração: 2h49min</p>
                        <p> Horários: </p> 
