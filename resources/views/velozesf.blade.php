        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://www.cinesystem.com.br/filmes/images/poster/velozes-e-furiosos-10.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder"> Velozes e Furiosos 10 </h1>
                        Dom Toretto e sua família devem lidar com o adversário mais letal que já enfrentaram. Alimentada 
            pela vingança, uma ameaça terrível emerge das sombras do passado para destruir o mundo de Dom 
            e todos que ele ama.
                        <p class="lead"></p>
                        ...
                        <br>
                        <p> Gênero: Ação/Aventura <br> Classificação indicativa: 12 anos <br> Duração: 2h10min </p>
                        <p> Horários: </p> 
                        <a href="comprar" class="btn btn-dark">R$| 18:30 </a>
                        <a href="comprar" class="btn btn-dark">R$| 20:00 </a>
