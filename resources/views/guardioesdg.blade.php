<html>
    <head>
        <head>
            ...
            <title>Guardiões da Galáxia vol.3</title>
            <!-- Favicon-->
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://www.cinesystem.com.br/filmes/images/poster/guardioes-da-galaxia-vol-3.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder"> Guardiões da Galáxia Volume 3 </h1>
                        Peter Quill deve reunir sua equipe para defender o universo e proteger um dos seus. Se a missão não
                        for totalmente bem-sucedida, isso pode levar ao fim dos Guardiões.
                        <p class="lead"></p>
                        ...
                        <br>
                        <p> Categoria: Aventura/Ficção Científica Classificação indicativa: 12 anos <br> Duração: 2h29min</p> <br>
                        <p> Horários: </p> 
